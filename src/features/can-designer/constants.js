...
export const FONTS = [
  ...
  { id: "font-2", label: "Knewave", style: "Knewave, sans-serif", weight: 400, url: "https://fonts.googleapis.com/css2?family=Knewave&display=swap" },
  { id: "font-3", label: "Libre Caslon Text", style: "Libre Caslon Text, serif", weight: 700, url: "https://fonts.googleapis.com/css2?family=Libre+Caslon+Text&display=swap" },
  { id: "font-4", label: "Monda", style: "Monda, sans-serif", weight: 600, url: "https://fonts.googleapis.com/css2?family=Monda:wght@400..700&display=swap" },
];
